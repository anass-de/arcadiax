    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#05070b]/85 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center gap-4">
          <Link
            href={isAdmin ? "/dashboard" : "/releases"}
              ...
              {guestLinks.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={[
                      "inline-flex items-center rounded-xl px-4 py-2.5 text-sm font-medium transition",
                      active
              ...
              {guestLinks.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={[
                      "inline-flex shrink-0 items-center rounded-xl border px-3 py-2 text-sm font-medium transition",
                      active
