...
export default function RegisterPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!cleanUsername || !cleanEmail || !cleanPassword || !cleanPasswordRepeat) {
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-2xl text-base leading-7 text-zinc-400 sm:text-lg">
                  Registriere dich mit Benutzername, E-Mail und Passwort und
                  erhalte Zugriff auf Releases, Kommentare, Profilfunktionen und
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-4">
                  ...
                  <div className="mt-1 text-xs leading-5 text-zinc-500">
                    Grundlage für Profile, Diskussionen und weitere Features.
                  </div>
                </div>
              </div>
            </div>
